...
namespace SingleSelectionSample
{
    public class TestViewModel : INotifyPropertyChanged
    {
        ...
        private SingleSelectionBehavior<PersonViewModel> _singlePersonSelectionBehavior;

        public TestViewModel()
        {
            _singlePersonSelectionBehavior = new SingleSelectionBehavior<PersonViewModel>(People);

            People.CollectionChanged += People_CollectionChanged;

            People.Add(new PersonViewModel("Bill", "Shakespear"));
            People.Add(new PersonViewModel("Jane", "Austen"));
            People.Add(new PersonViewModel("Robert", "Stevenson"));
        }
